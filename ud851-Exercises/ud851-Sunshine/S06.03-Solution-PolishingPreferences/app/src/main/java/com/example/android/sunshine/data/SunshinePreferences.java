...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String defLocation = context.getString(R.string.pref_location_default);
        return sharedPreferences.getString(keyLocation, defLocation);
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        String defUnit = context.getString(R.string.pref_units_metric);
        String prefUnit = sharedPreferences.getString(keyUnit, defUnit);
        String metric = context.getString(R.string.pref_units_metric);
        return metric.equals(prefUnit);
    }
