...
//      COMPLETED (13) Find each of the TextViews by ID
        ...
        mWeatherDescTextView = (TextView) findViewById(R.id.tv_weather_desc);
...
//          COMPLETED (27) Display the weather description (using SunshineWeatherUtils)
            ...
            mWeatherDescTextView.setText(description);
...
//          COMPLETED (30) Display the humidity
            mHumidityTextView.setText(getString(R.string.format_humidity, data.getFloat(
...
//          COMPLETED (31) Display the wind speed and direction
            mWindTextView.setText(SunshineWeatherUtils.getFormattedWind(this,
                    data.getFloat(INDEX_WEATHER_WIND_SPEED), data.getFloat(INDEX_WEATHER_DEGREES)));
//          COMPLETED (32) Display the pressure
            mPressureTextView.setText(getString(R.string.format_pressure, data.getFloat(
                    INDEX_WEATHER_PRESSURE)));
