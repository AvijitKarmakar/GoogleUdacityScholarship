...
public class NotificationUtils {
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent drinkWaterPendingIntent = PendingIntent.getService(context,
                ACTION_DRINK_PENDING_INTENT_ID, intent, PendingIntent.FLAG_CANCEL_CURRENT);
        //      COMPLETED (15) Create an Action for the user to tell us they've had a glass of water
        NotificationCompat.Action drinkWaterNotificationAction = new NotificationCompat.Action(
                R.drawable.ic_drink_notification, "I did it.", drinkWaterPendingIntent);
        //      COMPLETED (16) Return the action
        return drinkWaterNotificationAction;
    }
