...
public class NotificationUtils {
    ...
    private static final int WATER_REMINDER_PENDING_INTENT_REQ_CODE = 10000;
    private static final String WATER_REMINDER_NOTI_CHANNEL = "waterReminderNotificationChannel";
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        notificationManager.notify(WATER_REMINDER_PENDING_INTENT_REQ_CODE,
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        return PendingIntent.getActivity(context, WATER_REMINDER_PENDING_INTENT_REQ_CODE,
