...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private static final int GITHUB_SEARCH_LOADER = 1000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETED (24) Initialize the loader with GITHUB_SEARCH_LOADER as the ID, null for the bundle, and this for the context nu
    ...
    private void makeGithubSearchQuery() {
        ...
        if (TextUtils.isEmpty(githubQuery)) {
            mUrlDisplayTextView.setText(R.string.no_query_entered);
            return;
        }
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        ...
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                ...
                try {
                    return NetworkUtils.getResponseFromHttpUrl(new URL(searchUrl));
                } catch (IOException e) {
                    e.printStackTrace();
                    return null;
                }
