...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_QUERY_RESPONSE = "queryResponse";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(SEARCH_QUERY_URL) &&
                    savedInstanceState.containsKey(SEARCH_QUERY_RESPONSE)) {
                mUrlDisplayTextView.setText(savedInstanceState.getString(SEARCH_QUERY_URL));
                mSearchResultsTextView.setText(savedInstanceState.getString(SEARCH_QUERY_RESPONSE));
            }
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(SEARCH_QUERY_RESPONSE, mSearchResultsTextView.getText().toString());
    }
